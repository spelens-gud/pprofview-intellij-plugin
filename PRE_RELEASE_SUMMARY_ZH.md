...
[English](PRE_RELEASE_SUMMARY.md) | 简体中文

本文档总结了 Pprof Plus 插件发布前的准备工作。
...
- ✅ **RELEASE.md** - 快速发布指南，简化发布步骤
- ✅ **README.md** - 英文项目文档（已存在）
- ✅ **README_ZH.md** - 中文项目文档（已存在）
...
#### 发布文档
- ✅ `.github/RELEASE_CHECKLIST.md` - 详细发布检查清单
- ✅ `.github/SECRETS_SETUP.md` - GitHub Secrets 设置指南
...
- ✅ 禁用 `buildSearchableOptions` 任务以消除构建警告
...
4. **验证发布**
   - 确认插件已在 Marketplace 发布
   - 在 IDE 中测试安装

## 📚 相关文档

### 快速参考
- 🚀 [快速发布指南](RELEASE_ZH.md) - 简化的发布步骤
- 📋 [详细检查清单](.github/RELEASE_CHECKLIST_ZH.md) - 完整的发布检查清单
- 🔐 [Secrets 设置](.github/SECRETS_SETUP_ZH.md) - GitHub Secrets 设置指南
...
1. **配置 GitHub Secrets**（最重要！）
   - 按照 `.github/SECRETS_SETUP_ZH.md` 配置所有必需的 Secrets
   - 没有这些配置无法发布到 Marketplace
...
1. **最终检查**
   - 使用 `.github/RELEASE_CHECKLIST_ZH.md` 进行完整检查
   - 确保所有文档准确无误
...
3. 参考 [IntelliJ Platform 文档](https://plugins.jetbrains.com/docs/intellij/)
4. 在项目中创建 Issue
